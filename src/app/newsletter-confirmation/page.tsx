...
export const metadata: Metadata = {
  ...
  robots: { index: false },
  alternates: { canonical: `${SITE.url}/newsletter-confirmation` },
};
...
const resources = [
  {
    ...
    description:
      "30 pages de strategies eprouvees pour optimiser vos conversions",
    format: "PDF - 2.5 MB",
  },
  {
    icon: <BookOpen className="w-8 h-8 text-purple-600" />,
    title: "Checklist Design UX",
    description: "50 points de controle pour un design qui convertit",
    format: "PDF - 1.2 MB",
  },
  {
    ...
    description:
      "Video de 45 min sur la creation de landing pages performantes",
    format: "Video - Acces immediat",
  },
];
      ...
      <main className="container mx-auto px-4 sm:px-6 pt-32 pb-16 max-w-5xl">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-6">
            Votre inscription a notre newsletter a ete confirmee avec succes.
          </p>
          ...
          <div className="flex items-center justify-center gap-2 text-purple-600 bg-purple-50 rounded-lg py-3 px-6 inline-flex">
            ...
            <span className="font-medium">
              Vous recevrez prochainement nos meilleurs conseils dans votre boite
              mail
            </span>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-center text-gray-600 mb-8">
            Telechargez immediatement ces guides pour booster vos conversions des
            aujourd&apos;hui
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Appliquez nos conseils pour ameliorer vos taux de conversion
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold mb-1">
                    Partagez vos resultats
                  </h4>
                  <p className="text-sm text-gray-600">
                    N&apos;hesitez pas a nous contacter pour partager vos succes
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Reservez un appel gratuit de 30 minutes pour discuter de vos
                    objectifs
                  </p>
                </div>
              </div>
