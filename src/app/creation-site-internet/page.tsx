...
export default function CreationSiteInternetPage() {
  ...
  const faqSchema = {
    ...
    "@type": "FAQPage",
    mainEntity: [
      { "@type": "Question", name: "Combien coûte la création d'un site internet ?", acceptedAnswer: { "@type": "Answer", text: "Chez ConvertiLab, la création d'un site vitrine professionnel démarre à 490€. Ce prix inclut le design sur-mesure, 5 pages, le référencement de base, l'hébergement première année et le support 30 jours. Les e-commerces et sites sur-mesure font l'objet d'un devis." } },
      { "@type": "Question", name: "Combien de temps pour créer un site internet professionnel ?", acceptedAnswer: { "@type": "Answer", text: "ConvertiLab livre votre site en 2 semaines après validation de la maquette. La maquette est présentée sous 48h après l'appel découverte, soit environ 2 semaines de la prise de contact à la mise en ligne." } },
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <div className="flex items-center gap-2 bg-white px-4 py-3 rounded-xl shadow-sm border">
              ...
              <span className="font-bold text-gray-900">2 semaines</span>
