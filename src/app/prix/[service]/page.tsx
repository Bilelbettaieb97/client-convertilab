          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl border border-purple-100">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                  <p className="font-bold text-gray-900">Testez votre SEO avant de commander</p>
                  <p className="text-sm text-gray-600">Audit gratuit de 60+ points en 60 secondes</p>
                </div>
