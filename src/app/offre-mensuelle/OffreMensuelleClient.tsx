...
const approachSteps = [
  {
    ...
    title: "Analyse de votre activite",
    description:
      "On etudie votre secteur et vos concurrents pour creer un site qui convertit.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Un interlocuteur dedie. Modifications et maintenance incluses.",
  },
];
...
export default function OffreMensuelleClient() {
  const [billingMode, setBillingMode] = useState<"monthly" | "oneshot">(
    "monthly"
  );
      ...
      <section className="pt-28 pb-10 sm:pt-32 sm:pb-16 bg-background">
        <div className="container mx-auto px-5 sm:px-6 text-center max-w-4xl">
          ...
          <p className="text-muted-foreground text-sm sm:text-lg max-w-2xl mx-auto mb-7 animate-fade-in">
            On s&apos;occupe de tout pour que vous puissiez vous concentrer sur
            votre activite.
          </p>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-center sm:gap-4 mb-5 animate-fade-in">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto text-base sm:text-lg px-8 py-6 bg-primary hover:bg-primary/90"
            >
            ...
            <Button
              ...
              variant="ghost"
              size="lg"
              className="w-full sm:w-auto text-base sm:text-lg text-primary hover:text-primary/80"
            >
              <a href="#tarifs">
                Voir les tarifs
          ...
          <div className="container mx-auto px-5 sm:px-6 max-w-4xl">
            ...
            <div className="sm:hidden">
              ...
              <div className="flex justify-center mt-3 text-[11px] text-muted-foreground">
                ...
                <span>Glissez pour decouvrir</span>
            ...
            <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {approachSteps.map((step, i) => (
                <Card
                  key={i}
                  className="p-6 bg-muted/40 border-0 shadow-none"
                >
                  <div className="w-10 h-10 rounded-xl bg-primary flex items-center justify-center mb-3">
                    {step.icon}
                  </div>
            ...
            <div className="text-center mt-8">
              <Button
                asChild
                size="lg"
                className="w-full sm:w-auto text-base px-8 py-6 bg-primary hover:bg-primary/90"
              >
                <Link href="/offre-mensuelle/devis">
                  Lancer mon site
                  <ArrowRight className="ml-2 w-5 h-5" />
        ...
        <section className="py-10 sm:py-16 bg-muted/30">
          <div className="container mx-auto px-5 sm:px-6 max-w-3xl">
            ...
            <Card className="p-5 sm:p-8 bg-muted/40 border-0 shadow-none mb-4">
              <h3 className="text-base sm:text-xl font-bold text-foreground mb-4">
                Sans ConvertiLab
              </h3>
        ...
        <section id="tarifs" className="py-10 sm:py-16 bg-muted/30">
          <div className="container mx-auto px-5 sm:px-6 max-w-3xl">
              ...
              {pricingOffers.map((offer) => (
                <Card
                  ...
                  className={`p-5 sm:p-6 border-2 bg-background relative overflow-hidden ${
                    offer.highlight
                      ? "border-primary sm:scale-105 sm:shadow-xl sm:z-10"
                      : "border-border"
                  }`}
                >
                  {offer.badge && (
                  ...
                  <h3 className="text-sm sm:text-lg font-bold text-foreground mb-0.5">
                    {offer.name}
                  </h3>
                  <p className="text-muted-foreground text-[10px] sm:text-xs mb-4">
                    {offer.desc}
                  </p>
                    ...
                    {allFeatures.map((feat, i) => {
                      ...
                      return (
                        <li key={i} className="flex items-start gap-2">
                          {val === false ? (
                            <span className="w-4 h-4 flex-shrink-0 mt-0.5 text-muted-foreground/30">
                              —
                            </span>
                          ) : (
                  ...
                  <Button
                    ...
                    className={`w-full text-xs sm:text-sm ${
                      offer.highlight ? "bg-primary hover:bg-primary/90" : ""
                    }`}
                  >
                    <Link
                      href={`/offre-mensuelle/devis?offre=${offer.value}`}
                    >
                      Choisir {offer.name}
            ...
            <p className="text-center text-[10px] sm:text-xs text-muted-foreground mt-5">
              Proprietaire dans les 3 formules - Reference sur Google - Sans
              engagement
            </p>
          </div>
        </section>
      ...
      <section className="py-10 sm:py-16 bg-primary">
        <div className="container mx-auto px-5 sm:px-6 text-center max-w-2xl">
          ...
          <Button
            asChild
            size="lg"
            className="w-full sm:w-auto bg-background text-foreground hover:bg-background/90 text-sm sm:text-lg px-8 py-5 sm:py-6"
          >
            <Link href="/offre-mensuelle/devis">
