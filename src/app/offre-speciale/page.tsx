...
export default function OffreSpecialePage() {
  ...
  const offerSchema = {
    ...
    description: "Site vitrine 5 pages ou landing page haute conversion pour 300€. Design sur-mesure, SEO optimisé, livré en 7 jours. Places limitées.",
    price: "300",
    priceCurrency: "EUR",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      { "@type": "Question", name: "Combien de temps pour avoir mon site ?", acceptedAnswer: { "@type": "Answer", text: "7 jours ouvrés après validation de la maquette. La maquette est présentée sous 48h après notre premier échange." } },
