...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Combien de temps pour creer ma landing page ?", "acceptedAnswer": { "@type": "Answer", "text": "5 a 7 jours ouvres entre le brief valide et la mise en ligne. Nous respectons ce delai avec un engagement de 10% de remise en cas de depassement." } },
    { "@type": "Question", "name": "Ma landing page sera-t-elle compatible mobile ?", "acceptedAnswer": { "@type": "Answer", "text": "Absolument. Le design est pense mobile-first : 70% du trafic publicitaire vient du mobile. Votre page sera parfaitement optimisee sur tous les ecrans." } },
