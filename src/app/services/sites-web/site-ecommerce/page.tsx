...
const schemas = [
  ...
  { "@context": "https://schema.org", "@type": "Service", "name": "Creation Site E-commerce", "description": "Boutique en ligne professionnelle avec paiement securise, gestion des stocks et SEO integre.", "url": `${SITE.url}/services/sites-web/site-ecommerce`, "provider": { "@type": "Organization", "name": SITE.name }, "offers": { "@type": "Offer", "price": PRICING.ecommerce.from, "priceCurrency": "EUR", "availability": "https://schema.org/InStock" } },
];
