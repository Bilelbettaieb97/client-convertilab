  ...
  return (
    <main className="pt-20">
      ...
      <ServiceFAQ faqs={[
        ...
        { q: "Combien coûte une refonte de site web ?", a: "Chez ConvertiLab, une refonte de site vitrine démarre à partir de 400€. Le prix dépend du nombre de pages, des fonctionnalités à reprendre (formulaires, réservation, blog) et du travail SEO nécessaire. Vous recevez un devis détaillé et gratuit sous 24h." },
        { q: "Puis-je garder mon nom de domaine et mes contenus ?", a: "Oui. Votre nom de domaine vous appartient et reste inchangé. Nous reprenons vos contenus existants (textes, images, avis clients) en les retravaillant si besoin pour le SEO et la conversion. Vous ne repartez pas de zéro : vous capitalisez sur l'existant." }
      ]} />
