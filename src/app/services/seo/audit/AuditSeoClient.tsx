        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-2xl">
              Analyse complete de votre visibilite actuelle et axes d&apos;amelioration prioritaires.
            </p>
            <div className="flex flex-wrap gap-4">
              <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-gray-100">
                <Link href="/contact">Demander un audit <ArrowRight className="ml-2 w-5 h-5" /></Link>
              </Button>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Un audit complet pour comprendre votre situation et savoir exactement quoi ameliorer.
              </p>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-500 to-indigo-500 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Decouvrez les points forts et les axes d&apos;amelioration de votre referencement.
          </p>
          <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-gray-100">
            <Link href="/contact">Demander un audit <ArrowRight className="ml-2 w-5 h-5" /></Link>
          </Button>
