...
const features = [
  ...
  { name: 'Blog integre', landing: false, vitrine: true, ecommerce: true },
  ...
  { name: 'Analytics avances', landing: true, vitrine: true, ecommerce: true },
    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Trouvez la solution ideale en un coup d&apos;oeil</p>
        </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-border">
                <th className="py-4 pr-4 text-sm font-medium text-muted-foreground">Fonctionnalite</th>
                <th className="py-4 px-4 text-center">
                  <div className="text-sm font-bold text-foreground">Landing Page</div>
                  <div className="text-xs text-muted-foreground">{PRICING.landing.label}</div>
                </th>
                <th className="py-4 px-4 text-center bg-primary/5 rounded-t-lg">
                  ...
                  <div className="text-xs text-muted-foreground">{PRICING.vitrine.label}</div>
                </th>
                <th className="py-4 px-4 text-center">
                  <div className="text-sm font-bold text-foreground">E-commerce</div>
                  <div className="text-xs text-muted-foreground">{PRICING.ecommerce.label}</div>
                </th>
              </tr>
            </thead>
            <tbody>
