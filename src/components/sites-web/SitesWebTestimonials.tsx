...
const testimonials = [
  {
    quote: "Notre landing page a genere 150 leads en 2 semaines. Le ROI est incroyable.",
  ...
  {
    quote: "Chiffre d'affaires multiplie par 3 depuis le lancement de notre e-commerce.",
    result: "CA x3 en 6 mois",
    name: "Sophie M.",
    role: "Gerante, Boutique Mode",
    initial: "S"
  }
];
    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Des projets web qui ont transforme leur activite</p>
        </div>
