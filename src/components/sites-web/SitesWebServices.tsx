...
const services = [
  ...
  },
  {
    ...
    features: [
      ...
      "Blog integre (optionnel)",
      "Support technique 3 mois"
    ],
    idealFor: ["PME et artisans", "Professions liberales", "Restaurants"],
  ...
  },
  {
    ...
    idealFor: ["Commerces", "Artisans createurs", "Marques"],
  ...
  },
  {
    ...
    price: "Sur devis",
    description: "Portails clients, tableaux de bord, outils metiers, SaaS... Applications web robustes et evolutives.",
    features: [
      "Developpement sur-mesure",
      "Architecture scalable",
      "API et integrations tierces",
  ...
  },
  {
    ...
    price: "A partir de 790€",
    description: "Modernisez votre site obsolete tout en preservant votre referencement et ameliorant la conversion.",
    features: [
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
            Choisissez la solution adaptee a vos besoins
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Tous nos sites incluent : design responsive, optimisation SEO, hebergement et support technique.
          </p>
        </div>
                ...
                <div className={`p-8 rounded-2xl border bg-card shadow-lg relative ${service.highlight === "Le plus populaire" ? "border-primary ring-2 ring-primary/20" : "border-border"}`}>
                  ...
                  <div className="pt-6 border-t border-border space-y-3">
                    <div className="flex items-center gap-3 text-sm text-muted-foreground">
                      ...
                      <span>Satisfait ou retravaille</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm text-muted-foreground">
