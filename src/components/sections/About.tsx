...
import { BarChart3, Shield, Target, TrendingUp, Users, Zap, Heart, Sparkles } from "lucide-react";
  ...
  return (
    <section className="py-20 sm:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div
          ref={valuesRef}
          className={`mb-20 transition-all duration-700 delay-200 ${valuesVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
        ...
        <div
          ref={statsRef}
          className={`transition-all duration-700 delay-300 ${statsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
