  ...
  const steps = [
    {
      ...
      description:
        "On analyse votre marché, vos concurrents et vos objectifs pour définir la meilleure stratégie",
      duration: "Gratuit",
      ...
      details: {
        fullDescription:
          "Un audit complet de votre présence digitale et de votre marché pour définir une stratégie sur-mesure.",
        deliverables: [
        ...
        process:
          "Nous analysons en profondeur votre écosystème digital : site web, SEO, réseaux sociaux, publicité. On identifie les quick wins et les opportunités de croissance. Vous recevez un rapport complet avec nos recommandations.",
      },
    },
    {
      icon: Lightbulb,
      ...
      details: {
        fullDescription:
          "Création d'un plan marketing complet avec les leviers à activer, le calendrier et les KPIs à suivre.",
        deliverables: [
        ...
        process:
          "Nous élaborons votre stratégie en croisant les données de l'audit avec vos objectifs business. Chaque levier est détaillé avec son budget, son calendrier et ses KPIs de performance.",
      },
    },
    {
      icon: Code,
      ...
      details: {
        fullDescription:
          "Exécution de la stratégie : lancement des campagnes, création de contenu, configuration technique.",
        deliverables: [
    ...
    },
    {
      ...
      description:
        "On analyse les résultats et on optimise pour maximiser votre ROI",
      duration: "Continu",
      ...
      details: {
        fullDescription:
          "Suivi des performances et optimisation continue basée sur les données réelles.",
        deliverables: [
        ...
        process:
          "Chaque semaine, nous analysons les données et optimisons vos campagnes. Les budgets sont réalloués vers les leviers les plus performants. Vous recevez un rapport mensuel complet avec les KPIs, les apprentissages et les prochaines actions.",
      },
    },
    {
      icon: Rocket,
      ...
      description:
        "On développe les leviers qui fonctionnent pour accélérer votre croissance",
      duration: "Long terme",
      ...
      details: {
        fullDescription:
          "Scaling des campagnes performantes et exploration de nouveaux leviers de croissance.",
        deliverables: [
        ...
        process:
          "Une fois les leviers validés, on passe en mode croissance. On augmente les budgets sur ce qui fonctionne, on explore de nouveaux canaux, et on met en place des automations pour maximiser votre ROI à long terme.",
      },
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Un processus éprouvé en 5 étapes pour booster votre croissance
            digitale
          </p>
        </div>
              ...
              >
                ...
                >
                  ...
                  <div className="relative bg-slate-900/50 backdrop-blur-xl border border-slate-800/50 rounded-2xl p-6 sm:p-8 hover:border-slate-700/50 transition-all duration-500 overflow-hidden">
                    ...
                    {/* Glow effect */}
                    <div
                      className={`absolute -inset-0.5 bg-gradient-to-r ${step.gradient} rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500 -z-10`}
                    ></div>
                    ...
                    <div className="relative flex flex-col sm:flex-row items-start gap-6">
                      ...
                      <div className="flex-1 space-y-3">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                          ...
                          {/* Badge durée */}
                          <div
                            className={`inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r ${step.gradient} rounded-full text-white text-sm font-bold shadow-lg ${step.glowColor} whitespace-nowrap`}
                          >
                        ...
                        <div className="flex justify-end">
                          <div
                            className={`flex items-center gap-2 bg-gradient-to-r ${step.gradient} px-4 py-2.5 rounded-full text-white text-sm font-bold shadow-lg ${step.glowColor} group-hover:scale-110 group-hover:shadow-xl transition-all duration-300`}
                          >
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3 sm:space-y-4 pb-4 sm:pb-6 border-b border-slate-800">
                <div className="flex items-center justify-between text-xs sm:text-sm">
                  ...
                  <span className="font-bold text-white">
                    {Math.round(
                      ((selectedStep + 1) / steps.length) * 100
                    )}
                    %
                  </span>
                </div>
              ...
              <DialogHeader>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-4">
                  <div
                    className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${steps[selectedStep].gradient} rounded-xl sm:rounded-2xl flex items-center justify-center shadow-2xl flex-shrink-0`}
                  >
                    {(() => {
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xs sm:text-sm text-slate-400 mb-1">
                      Étape {steps[selectedStep].number}
                    </div>
                  ...
                  <div
                    className={`px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r ${steps[selectedStep].gradient} rounded-full text-white text-xs sm:text-sm font-bold flex-shrink-0`}
                  >
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <ul className="space-y-2 sm:space-y-3">
                  {steps[selectedStep].details.deliverables.map(
                    (deliverable, idx) => (
                      <li
                        key={idx}
                      ...
                      >
                        <div
                          className={`w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-br ${steps[selectedStep].gradient} rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5`}
                        >
