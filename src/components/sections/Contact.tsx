            ...
            <div className="lg:col-span-2 order-1 lg:order-2 space-y-6">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-lg border border-slate-200 dark:border-slate-800">
                <div className="space-y-4">
                  <a href={`mailto:${SITE.email}`} className="flex items-center gap-4 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white text-sm">{SITE.email}</p>
                      <p className="text-xs text-slate-500">Reponse sous 2h</p>
                    </div>
                  </a>
                  <a href={`tel:${SITE.phone}`} className="flex items-center gap-4 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white text-sm">{SITE.phoneDisplay}</p>
                  ...
                  <div className="flex items-center gap-4 p-3 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Paris & Ile-de-France</p>
                    </div>
                  </div>
                </div>
              </div>
