  ...
  const faqs = [
    {
      ...
      answer: `Nos tarifs démarrent ${PRICING.landing.label} pour une landing page et ${PRICING.vitrine.label} pour un site vitrine complet. Le prix dépend du nombre de pages, des fonctionnalités et du design souhaité. Nous vous fournissons un devis détaillé et transparent sous 24h. Possibilité de paiement en mensualités.`
    },
    {
