      ...
      <AnimatePresence mode="wait">
        ...
        {step === 1 && (
          <motion.div key="step1" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }}>
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-2">Quel site voulez-vous analyser ?</h2>
            <p className="text-white/50 mb-5 sm:mb-8 text-sm">Entrez l&apos;URL de votre site pour generer les fichiers robots.txt et sitemap.xml.</p>
        ...
        {step === 2 && (
          <motion.div key="step2" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }}>
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-2">Où envoyer vos fichiers ?</h2>
            <p className="text-white/50 mb-5 sm:mb-8 text-sm">Les fichiers robots.txt et sitemap.xml seront envoyés à votre adresse email.</p>
