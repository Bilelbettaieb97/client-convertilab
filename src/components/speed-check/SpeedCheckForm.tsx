...
const ANALYSIS_STEPS = [
  ...
  "Analyse du poids de page...",
  "Vérification des images…",
  "Détection des scripts bloquants…",
          ...
          <motion.div key="step3" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }}>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3 sm:p-6 sm:space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-white/40">Site a tester</p>
            ...
            <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row">
              ...
              >
                <Zap className="w-5 h-5 mr-2" /> Lancer le test vitesse
              </Button>
            </div>
          </motion.div>
        )}
        ...
        {step === 4 && result && (
          <motion.div key="step4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            ...
            {pdfBase64 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }} className="mb-6 text-center">
                <a
                  ...
                  download={`rapport-vitesse-${result.domain}.pdf`}
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {[
                { label: "Temps Serveur", score: result.scores.server },
                { label: "Poids Page", score: result.scores.weight },
                { label: "Assets", score: result.scores.assets },
                { label: "Render Blocking", score: result.scores.blocking },
                { label: "Bonnes Pratiques", score: result.scores.practices },
              ].map((cat, i) => (
                <motion.div
                  key={cat.label}
                  initial={{ opacity: 0, y: 10 }}
            ...
            <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/30 border border-purple-500/30 rounded-xl p-6 text-center">
              ...
              <p className="text-white/50 text-sm mb-4">
                Notre équipe peut optimiser la vitesse de votre site et améliorer l&apos;expérience utilisateur.
              </p>
              <a
