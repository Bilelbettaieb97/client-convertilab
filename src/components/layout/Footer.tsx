  ...
  return (
    <footer className="bg-gray-900 text-white pt-16 sm:pt-20 pb-8 sm:pb-10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 sm:gap-10 mb-12 sm:mb-16">
          ...
          <div className="space-y-4 lg:col-span-1">
            ...
            <div className="flex space-x-3 pt-2">
              <a href={SITE.social.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="p-3 bg-purple-600/20 rounded-lg hover:bg-purple-600/30 hover:scale-110 focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:outline-none transition-all duration-300">
              ...
              <a href={SITE.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="p-3 bg-purple-600/20 rounded-lg hover:bg-purple-600/30 hover:scale-110 focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:outline-none transition-all duration-300">
