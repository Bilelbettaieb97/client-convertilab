...
const PromoBanner = () => {
  ...
  // FIX: Read localStorage at mount to avoid re-showing if already closed
  useEffect(() => {
      ...
      <div className="container mx-auto flex items-center justify-between relative z-10 gap-2">
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          <span className="font-semibold text-xs sm:text-sm leading-tight truncate">
            Votre site internet professionnel pour seulement <span className="font-extrabold">39 &euro;/mois</span>
          </span>
        </div>
