...
export const comparisons: Comparison[] = [
  {
    ...
    verdict: "Pour un site vitrine performant et sécurisé, Next.js est le meilleur choix. WordPress reste pertinent pour les blogs avec beaucoup de contenu à gérer en autonomie. Chez ConvertiLab, nous créons des sites Next.js à partir de 490€ avec des performances imbattables.",
    faqItems: [
  ...
  },
  {
    ...
    verdict: "Wix convient pour un projet personnel ou un test rapide. Pour une entreprise sérieuse qui veut convertir ses visiteurs en clients, un site professionnel fait par une agence est bien plus rentable. Chez ConvertiLab, nos sites démarrent à 490€.",
    faqItems: [
      ...
      { question: "Combien coûte un site agence vs Wix sur 3 ans ?", answer: "Wix Premium : environ 504€ sur 3 ans (14€/mois). Un site agence : 490€ + hébergement (environ 40€/mois). Le coût est similaire mais les résultats business sont incomparables." },
  ...
  },
  {
    ...
    verdict: "Squarespace offre de beaux templates mais reste limité pour une stratégie digitale ambitieuse. Un site sur-mesure ConvertiLab vous donne un avantage compétitif réel avec des performances et un SEO supérieurs, à partir de 490€.",
    faqItems: [
  ...
  },
  {
    ...
    verdict: "Shopify est idéal pour tester un concept rapidement. Mais dès que votre CA dépasse 5000€/mois, les commissions et abonnements rendent un site sur-mesure plus rentable. ConvertiLab crée votre e-commerce à partir de 1490€, sans commission.",
    faqItems: [
      { question: "Combien coûte Shopify vs un site sur-mesure sur 1 an ?", answer: "Shopify Basic : 384€/an + commissions (~2% du CA). Un site ConvertiLab : 1490€ + hébergement (~59€/mois). Dès 2000€/mois de CA, le sur-mesure est plus rentable." },
  ...
  },
  {
    ...
    verdict: "Les deux sont complémentaires. Le site vitrine est votre vitrine permanente sur le web (SEO, crédibilité). La landing page est votre outil de conversion pour les campagnes. ConvertiLab crée les deux à partir de 490€.",
    faqItems: [
  ...
  },
  {
    ...
    verdict: "ConvertiLab combine le meilleur des deux : l'expertise et la fiabilité d'une agence avec la réactivité et les tarifs compétitifs d'un freelance. Sites à partir de 490€ avec un interlocuteur dédié.",
    faqItems: [
      ...
      { question: "Les tarifs agence sont-ils toujours plus chers ?", answer: "Pas nécessairement. ConvertiLab propose des sites à partir de 490€, un tarif compétitif même par rapport aux freelances, avec une qualité et un suivi supérieurs." },
    ],
    relatedService: "/services/sites-web",
  },
  {
    ...
    verdict: "Un site gratuit peut nuire à votre image et vous fait perdre des clients. Pour 490€ chez ConvertiLab, vous obtenez un site professionnel qui inspire confiance et génère du business. C'est un investissement, pas une dépense.",
    faqItems: [
      ...
      { question: "490€ est-il un bon investissement pour un site ?", answer: "Absolument. Un site professionnel qui convertit 1 seul client par mois rembourse largement l'investissement. C'est le support marketing le plus rentable qui existe." },
  ...
  },
  {
    ...
    faqItems: [
      ...
      { question: "Peut-on gérer les deux avec le même budget ?", answer: "Nous recommandons de se concentrer sur une plateforme d'abord, puis d'étendre. Avec un budget de 1 500€/mois, on peut commencer à tester les deux en parallèle." },
    ],
  ...
  },
  {
    ...
    verdict: "Si votre site a un bon référencement, optez pour une refonte (à partir de 400€). Si votre site est obsolète et mal référencé, un nouveau site (à partir de 490€) est plus judicieux. ConvertiLab vous conseille après un audit gratuit.",
    faqItems: [
