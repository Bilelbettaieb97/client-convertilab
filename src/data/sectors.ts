    ...
    faqItems: [
      {
        ...
        answer:
          "Nos sites vitrines pour restaurants démarrent à 890 €. Ce tarif inclut le menu en ligne, la galerie photos, le bouton de réservation, l'intégration Google Maps et un an d'hébergement. Pour un système de réservation avancé ou de commande en ligne, comptez un supplément selon vos besoins.",
      },
      {
        question:
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour cabinet d'avocats démarre à 890 €. Ce prix comprend un design professionnel, les pages par domaine de compétence, le formulaire de contact sécurisé, les mentions légales conformes et un an d'hébergement. Un blog juridique ou un espace client sécurisé peut être ajouté en option.",
      },
      {
        question:
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour artisan démarre à 890 €. Ce tarif inclut la galerie de réalisations, le formulaire de demande de devis, les zones d'intervention, les témoignages clients et un an d'hébergement. C'est un investissement qui se rentabilise dès les premiers chantiers obtenus grâce au site.",
      },
      {
        question:
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour agence immobilière démarre à 890 €. Il comprend le catalogue de biens, la recherche par critères, les pages par quartier, le formulaire d'estimation et un an d'hébergement. Pour un site avec import automatique depuis votre logiciel métier, un devis personnalisé sera établi.",
      },
      {
        question:
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour coach ou consultant démarre à 890 €. Il comprend votre page de présentation, vos offres, l'intégration Calendly, les témoignages, le blog et un an d'hébergement. C'est l'investissement le plus rentable pour développer votre activité au-delà du bouche-à-oreille.",
      },
      {
        question:
    ...
    faqItems: [
      {
        ...
        answer:
          "Nos boutiques e-commerce démarrent à 1 490 €. Ce tarif inclut le catalogue produits, le paiement sécurisé Stripe, la gestion des stocks, les pages catégories SEO, la relance panier abandonné et un an d'hébergement. Le prix final dépend du nombre de produits et des fonctionnalités souhaitées.",
      },
      {
        question:
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour cabinet dentaire démarre à 890 €. Il comprend la présentation du cabinet et de l'équipe, les pages par type de soin, la prise de rendez-vous en ligne, la FAQ patients et un an d'hébergement. Un module de galerie avant/après peut être ajouté en option.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour cabinet médical démarre à 890 €. Il inclut la présentation du praticien, les pages par consultation, la prise de RDV en ligne, les informations pratiques et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour salon de coiffure démarre à 890 €. Il comprend la galerie de réalisations, la grille tarifaire, la réservation en ligne, la présentation de l'équipe et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour boulangerie démarre à 890 €. Il comprend la galerie photos, la carte des produits, le formulaire de commande, les horaires et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site portfolio pour photographe démarre à 890 €. Il comprend les galeries thématiques, la page tarifs, le formulaire de réservation, le blog et un an d'hébergement. Les galeries clients privées sont disponibles en option.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Une landing page SaaS démarre à 490 € pour une page unique optimisée conversion, un site vitrine multi-pages avec blog, pricing et changelog à 890 €. L'objectif est toujours de maximiser le ratio visiteurs → inscriptions.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site portfolio pour architecte démarre à 890 €. Il comprend les galeries de projets, les études de cas, les pages par spécialité, le formulaire de contact et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour cabinet comptable démarre à 890 €. Il comprend les pages par service, la grille tarifaire, le blog fiscal, le formulaire de devis et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine avec commande en ligne pour fleuriste démarre à 890 €. Il comprend le catalogue, la commande en ligne, la galerie par événement et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour salle de sport démarre à 890 €. Il comprend le planning des cours, les tarifs, la présentation des coachs, la galerie et le formulaire de séance d'essai avec un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour institut de beauté démarre à 890 €. Il comprend la carte des soins, la réservation en ligne, la galerie, les chèques cadeaux et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour agence de voyage démarre à 890 €. Il comprend les fiches destinations, le catalogue par thème, le formulaire sur mesure, le blog voyage et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour auto-école démarre à 890 €. Il comprend les formules et tarifs, le formulaire d'inscription, les témoignages élèves, le taux de réussite et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour traiteur démarre à 890 €. Il comprend la galerie d'événements, les menus par occasion, le formulaire de devis, les témoignages et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour électricien démarre à 890 €. Il comprend les pages par service, le formulaire de devis, les zones d'intervention, les certifications et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour plombier démarre à 890 €. Il comprend le numéro d'urgence, les pages par service, le formulaire de devis, les zones d'intervention et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour ostéopathe ou kiné démarre à 890 €. Il comprend la présentation du praticien, les pages par pathologie, la prise de RDV en ligne, le blog et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour garage automobile démarre à 890 €. Il comprend les pages par service, la grille tarifaire, la prise de RDV en ligne, les avis clients et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour bijouterie démarre à 890 €. Il comprend le catalogue de collections, la galerie HD, la page sur mesure, l'histoire de la maison et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour centre de formation démarre à 890 €. Il comprend le catalogue de formations, le formulaire d'inscription, les témoignages, la page équipe et un an d'hébergement.",
      },
      {
        question: "Les élèves pourront-ils s'inscrire en ligne ?",
        answer:
    ...
    faqItems: [
      {
        ...
        answer:
          "Nos sites pour vétérinaires démarrent à 890 €. Ce tarif inclut la prise de rendez-vous en ligne, les fiches services, la page urgences, l'intégration Google Maps et un an d'hébergement. Un blog santé animale ou un espace client peut être ajouté en option.",
      },
      {
        question: "Les clients pourront-ils prendre RDV en ligne ?",
        answer:
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour notaire démarre à 890 €. Ce prix inclut un design professionnel, les pages par domaine d'intervention, le formulaire de contact sécurisé et un an d'hébergement. Un blog juridique ou un espace documentaire client peut être ajouté en option.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Nos sites pour psychologues et thérapeutes démarrent à 890 €. Ce prix inclut un design apaisant, les pages par spécialité, la prise de RDV en ligne, la section tarifs et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour caviste démarre à 890 €. Ce prix inclut le catalogue de vins en ligne, la page événements, le blog accords mets-vins et un an d'hébergement. La vente en ligne avec paiement sécurisé peut être ajoutée en option.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour pizzeria démarre à 890 € (menu digital, horaires, itinéraire, un an d'hébergement). Avec commande en ligne, paiement sécurisé et click & collect, comptez à partir de 1 490 €. Vous économisez les commissions des plateformes de livraison.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour hôtel ou chambre d'hôtes démarre à 890 € (galeries photos, fiches chambres, page activités, un an d'hébergement). Avec un moteur de réservation et le paiement en ligne, comptez à partir de 1 490 €. Vous économisez les commissions des OTA (Booking, Airbnb).",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour crèche ou structure de garde d'enfants démarre à 890 €. Ce prix inclut un design chaleureux, la page projet pédagogique, la présentation de l'équipe, le formulaire de pré-inscription et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour déménageur démarre à 890 €. Ce prix inclut le formulaire de devis en ligne, les pages services, la zone d'intervention, les témoignages et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour serrurier démarre à 890 €. Ce prix inclut le numéro cliquable, la grille tarifaire, les pages par zone d'intervention, les avis clients et un an d'hébergement. Le SEO local est inclus pour apparaître en urgence.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour paysagiste démarre à 890 €. Ce prix inclut le portfolio avant/après, le formulaire de devis, les pages services, la galerie photos et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour peintre en bâtiment démarre à 890 €. Ce prix inclut le portfolio avant/après, le formulaire de devis, les pages par spécialité, les certifications et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour menuisier démarre à 890 €. Ce prix inclut la galerie de réalisations, le formulaire de devis, les pages par spécialité, la section matériaux et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site vitrine pour carreleur démarre à 890 €. Ce prix inclut le portfolio avant/après, le formulaire de devis, les pages par type de pose, les avis clients et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour chauffagiste/climaticien démarre à 890 €. Ce prix inclut les pages services, les certifications, le formulaire de devis, la section aides financières et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site portfolio pour agence de communication démarre à 890 €. Ce prix inclut le portfolio interactif, les études de cas, les pages par expertise, le blog et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour cabinet de recrutement démarre à 890 €. Ce prix inclut l'espace offres d'emploi, le formulaire candidature, les pages par secteur, les études de cas et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        question: "Combien coûte un site pour un centre de formation ?",
        answer:
          "Un site pour centre de formation démarre à 890 €. Ce prix inclut le catalogue filtrable, les fiches formation, le formulaire d'inscription, la certification Qualiopi et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour société de nettoyage démarre à 890 €. Ce prix inclut les pages prestations, les références clients, le formulaire de devis B2B, les certifications et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour entreprise de transport/logistique démarre à 890 €. Ce prix inclut la présentation de la flotte, les pages services, le formulaire de cotation, les certifications et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour opticien démarre à 890 €. Ce prix inclut le catalogue montures, la prise de RDV, les pages services, la section mutuelles et un an d'hébergement. La vente en ligne de lentilles peut être ajoutée en option.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour pharmacie démarre à 890 €. Ce prix inclut les horaires de garde, les pages services, le click & collect, la section conseils santé et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Un site pour librairie démarre à 890 €. Ce prix inclut les coups de coeur, la page événements, la commande en ligne avec retrait, le blog et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Nos sites pour associations démarrent à 890 €. Ce tarif inclut le design engageant, l'agenda des événements, le formulaire de don, l'espace bénévole et un an d'hébergement. Nous proposons des tarifs adaptés aux structures associatives.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Nos sites pour entreprises de sécurité incendie démarrent à 890 €. Ce tarif inclut la structuration de vos services, le formulaire de devis, la mise en avant de vos certifications et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Nos sites pour entreprises de recyclage et environnement démarrent à 890 €. Ce tarif inclut un design éco-responsable, la structuration de vos services, le formulaire de devis et un an d'hébergement.",
      },
      {
    ...
    faqItems: [
      {
        ...
        answer:
          "Nos sites pour le spectacle et l'événementiel démarrent à 890 €. Ce tarif inclut le design immersif, la billetterie en ligne, le calendrier des représentations et un an d'hébergement.",
      },
      {
